...
parser.add_argument('--type', default='experiment_pcl', type=str,
                    help='experiment directory')
...
# 1. major type clustering
# 2. celltype clustering
# 3-12. Inside majortype, celltype classification
...
def preprocess_dataset(traindir: str="", 
    ...
    adata = sc.read(traindir)
    adata.obs['x'] = adata.obs['celltype']
    #adata = sc.read()
