...
def train(data_path, dataset_name, save_path):
    ...
    # save txt
    save_path = os.path.join(save_path, "scVI")
    if os.path.exists(save_path)!=True:
        os.makedirs(save_path)
    txt_path = os.path.join(save_path, "metric_scVI.txt")
    f = open(txt_path, "a")
    ...
    np.savetxt(os.path.join(save_path, "feature_scVI_{}.csv".format(dataset_name)), adata.obsm["X_scVI"], delimiter=',')
    labels.to_csv(os.path.join(save_path, "gt_label_scVI_{}.csv".format(dataset_name)))
    labels_pred.to_csv(os.path.join(save_path, "pd_label_scVI_{}.csv".format(dataset_name)))
