...
if __name__ == "__main__":
    ...
    if args.filterCSVTag:
        ...
        if args.filetype == '10X':
            ...
            datasetFileName = args.datasetName + "_counts.csv"
            expressionFilename = args.LTMGDir + args.datasetName + "/" + args.expressionFile
            if os.path.exists(args.LTMGDir + args.datasetName) != True:
                os.makedirs(args.LTMGDir + args.datasetName)
            preprocessingCSV(args.datasetDir, datasetFileName, expressionFilename, args.delim, args.transform,
                             args.cellRatio, args.geneRatio, args.geneCriteria, args.geneSelectnum, args.transpose, args.tabuCol)
