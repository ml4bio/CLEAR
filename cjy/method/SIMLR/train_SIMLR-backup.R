...
source("./method/SIMLR/R/network.diffusion.R")
source("./method/SIMLR/R/utils.simlr.R")
source("./method/SIMLR/R/tsne.R")
...
# load the datasets
load(file="./method/SIMLR/data/Test_1_mECS.RData")
load(file="./method/SIMLR/data/Test_2_Kolod.RData")
load(file="./method/SIMLR/data/Test_3_Pollen.RData")
load(file="./method/SIMLR/data/Test_4_Usoskin.RData")


data = Test_1_mECS$in_X
print(str(data))

print("1111")

print(str(Test_1_mECS$true_labs[,1]))
